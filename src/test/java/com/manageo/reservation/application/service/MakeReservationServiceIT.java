...
@SpringBootTest
class MakeReservationServiceIT {
	...
	void shouldSaveReservation() {
		...
		Reservation reservationReturned = makeReservationUseCase.apply(reservation);
		
		assertThat(reservationReturned).usingRecursiveComparison().isEqualTo(reservation);
	}
